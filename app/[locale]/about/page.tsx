      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="space-y-8">
          ...
          <section className="bg-white rounded-2xl border border-slate-100 p-6">
            ...
            <p className="text-slate-600 leading-relaxed mb-4">Traditional news media covers conflicts reactively. War Data Hub provides continuous, structured monitoring that persists beyond news cycles. Where newspapers provide narrative, we provide data.</p>
