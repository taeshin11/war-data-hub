...
export const metadata: Metadata = {
  ...
  description: 'How to use War Data Hub. FAQ about our data, methodology, and features.',
  keywords: 'war data, conflict data, military data, war statistics, open source intelligence, OSINT database, FAQ, guide',
}

export default function FaqPage() {
  const faqs = [
    { q: 'What is War Data Hub and who is it for?', a: 'War Data Hub is a free, publicly accessible platform that provides an open-source repository of conflict datasets, research reports, and war data resources for analysts and researchers. Designed for journalists, researchers, policy analysts, students, and NGO workers. No registration or payment required.' },
    ...
    { q: 'Is this platform free?', a: 'War Data Hub is entirely free with no registration required. The platform is sustained through advertising. No paywalls or premium tiers.' },
    { q: 'Can I use or cite this data?', a: 'Yes, with attribution to the platform and original primary source. For academic publications, cross-reference against primary sources. For bulk access, contact us at contact@war-data-hub.vercel.app.' }
  ]
  return (
    <main className="bg-slate-50 min-h-screen">
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <h1 className="text-4xl font-bold text-slate-900 mb-4">How to Use War Data Hub</h1>
